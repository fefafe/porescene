...
.. raw:: html
   ...
   <div class="ps-tiles">
     <div class="ps-tile non-clickable">
       ...
       <p class="ps-tile-desc">Creator &amp; maintainer of PoreScene</p>
     </div>
     ...
     <div class="ps-tile non-clickable">
       ...
       <p class="ps-tile-desc">Research group leader <a href="https://tvt.ovgu.de/tpm" target="_blank" rel="noopener noreferrer">Transport in Porous Media</a></p>
     </div>
   </div>
