...
:func:`~porescene.worker.quantity_range` -- and
:func:`~porescene.image.compose_colorbar` joins the two images. Keeping them apart means
the same render can be given a colorbar in a different place, or none at all:
